...
for col in data.columns:
    ...
    if col == "pressure":
        data_result['real label'] = ["Over" if i > 1014 else "Normal" if i > 1002 else "Warning" for i in data_result['real label']]
        data_result['predicted (rbf) label'] = ["Over" if i > 1014 else "Normal" if i > 1002 else "Warning" for i in data_result['predicted (rbf) label']]
        data_result['predicted (linear) label'] = ["Over" if i > 1014 else "Normal" if i > 1002 else "Warning" for i in data_result['predicted (linear) label']]
    elif col == "temp":
